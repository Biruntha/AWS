 ...
 */
public class AWSUserStoreConstants {

    //Properties for AWS User Store Manager
    public static final ArrayList<Property> AWS_MANDATORY_UM_PROPERTIES = new ArrayList<>();
    public static final ArrayList<Property> AWS_OPTIONAL_UM_PROPERTIES = new ArrayList<>();
    public static final ArrayList<Property> AWS_ADVANCED_UM_PROPERTIES = new ArrayList<>();
    ...
    static {
        ...
        setMandatoryProperty(AWSConstants.REGION, "Region", "", "Region which is used select a regional endpoint to make requests", false);
        setMandatoryProperty(AWSConstants.API_VERSION, "API Version", "", "Cloud directory API version", false);
        setMandatoryProperty(AWSConstants.PATH_TO_USERS, "Path To Users", "", "This is a path to identify the Users object in the tree structure.", false);
        setMandatoryProperty(AWSConstants.PATH_TO_ROLES, "Path To Roles", "", "This is a path to identify the Roles object in the tree structure.", false);
        setMandatoryProperty(AWSConstants.MEMBERSHIP_TYPE_OF_ROLES, "Membership Type Of Roles", "", "Indicates how you are going to maintain user and role objects relationship. Possible values: link, attribute.", false);
        setMandatoryProperty(AWSConstants.DIRECTORY_ARN, "DirectoryArn", "", "Directory in which the objects will be created.", false);
        setMandatoryProperty(AWSConstants.SCHEMA_ARN, "SchemaArn", "", "Schema arn of the directory.", false);
        setMandatoryProperty(AWSConstants.FACET_NAME_OF_USER, "FacetName Of User", "", "Facet name of the user object.", false);
        setMandatoryProperty(AWSConstants.FACET_NAME_OF_ROLE, "FacetName Of Role", "", "Facet name of the role object.", false);
        setMandatoryProperty(AWSConstants.USER_NAME_ATTRIBUTE, "UserName Attribute", "", "The name of the attribute is used to identify the user name of user entry.", false);
        setMandatoryProperty(AWSConstants.PASSWORD_ATTRIBUTE, "Password Attribute", "", "The name of the attribute is used to identify the password of user entry.", false);
        setMandatoryProperty(AWSConstants.ROLE_NAME_ATTRIBUTE, "RoleName Attribute", "", "The name of the attribute is used to identify the role name of role entry.", false);
        ...
        setProperty(UserStoreConfigConstants.membershipAttribute, "Membership Attribute", "", "Define the attribute that contains the distinguished names of user objects that are in a role.");
        setProperty(UserStoreConfigConstants.memberOfAttribute, "Member Of Attribute", "", "Define the attribute that contains the distinguished names of role objects that user is assigned to.");
        ...
        setProperty(AWSRealmConstants.PROPERTY_PASSWORD_ERROR_MSG, "Password RegEx Violation Error Message", "Password pattern policy violated.",
        ...
        setProperty(AWSRealmConstants.PROPERTY_USER_NAME_ERROR_MSG, "Username RegEx Violation Error Message", "Username pattern policy violated.",
        ...
        setAdvancedProperty(AWSRealmConstants.PASSWORD_HASH_METHOD, "PLAIN_TEXT");
